...
const STATIC_TEMPLATES = [
  ...
  },
  {
    ...
    uses: 0,
    createdAt: NOW,
    image: '/templates/paris-cafe.jpg',
    prompt:
      'Streetwear fashion editorial photo. Subject wearing a bold yellow cropped hoodie and matching yellow jogger sweatpants with white ankle boots. Standing confidently on an outdoor basketball court with a clear blue sky and ocean in the background. Power pose, hands on hoodie collar. Bright sunny day, clean athletic aesthetic, street fashion meets luxury. Editorial photography quality, 4K.',
  },
  {
    id: '36',
    emoji: '💚',
    ...
    uses: 0,
    createdAt: NOW,
    image: '/templates/rooftop-night.jpg',
    prompt:
      'Urban neon fashion editorial. Subject posing against a vibrant teal green wall under a glowing neon sign. Wearing a white crop top, black and white wide-leg striped trousers, red oval sunglasses, and a small red mini bag. Dynamic leaning pose, confident attitude. Moody club-night lighting, Y2K meets modern aesthetic, bold color contrast. Editorial photography, 4K.',
  },
  {
    id: '32',
    emoji: '🌺',
