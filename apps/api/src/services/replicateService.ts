// ============================================================================
// LEGACY: Replicate pipeline (face-swap + FLUX Kontext + Real-ESRGAN upscale).
// Replaced by geminiImageService.ts (Nano Banana Pro) on 2026-07-13.
// Kept commented out for rollback: uncomment this file and restore the import
// in routes/generate.ts to '../services/replicateService.js'.
// ============================================================================
