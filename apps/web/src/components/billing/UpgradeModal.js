    ...
    return (_jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4", onClick: (e) => { if (e.target === e.currentTarget)
            onClose(); }, children: _jsxs("div", { style: {
                ...
                position: 'relative',
                                ...
                                display: 'flex',
                                flexDirection: 'column',
                            }, children: [_jsx("div", { style: { fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.08em', color: '#888', marginBottom: 12 }, children: "Pro" }), _jsxs("div", { style: { display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 2 }, children: [_jsx("span", { style: { fontSize: 18, fontWeight: 700, color: '#ff5c7a', textDecoration: 'line-through', fontFamily: '"DM Sans", sans-serif' }, children: "$4.99" }), _jsx("span", { style: { fontSize: 34, fontWeight: 800, color: '#fff', lineHeight: 1, fontFamily: '"DM Sans", sans-serif' }, children: "$2.99" })] }), _jsx("div", { style: { fontSize: 12, color: '#888', marginBottom: 14 }, children: "/ month" }), _jsx("ul", { style: { listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 20, flex: 1 }, children: ['10 generations / month', 'All templates + early access', '4K quality', 'No watermark'].map(f => (_jsxs("li", { style: { fontSize: 12, color: '#bbb', display: 'flex', alignItems: 'center', gap: 7 }, children: [_jsx("span", { style: { color: '#ff6b9d', fontSize: 9 }, children: "\u2726" }), f] }, f))) }), _jsx("button", { onClick: () => handleCheckout('pro'), disabled: loading === 'pro', style: {
