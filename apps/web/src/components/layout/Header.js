...
function AvatarMenu({ email }) {
    ...
    return (_jsxs("div", { ref: ref, style: { position: 'relative', flexShrink: 0 }, children: [_jsx("button", { onClick: () => setOpen((v) => !v), style: {
                ...
                }, children: (email[0] ?? 'U').toUpperCase() }), open && (_jsxs("div", { style: {
                    position: 'absolute', right: 0, top: 'calc(100% + 8px)',
                    background: '#16161a', border: '1px solid rgba(255,255,255,0.08)',
                    borderRadius: 14, padding: 6, minWidth: 190,
                    boxShadow: '0 12px 40px rgba(0,0,0,0.5)',
                    zIndex: 999,
                }, children: [_jsxs("div", { style: { padding: '8px 10px 10px', borderBottom: '1px solid rgba(255,255,255,0.06)', marginBottom: 4 }, children: [_jsx("div", { style: { fontSize: 11, color: '#555', marginBottom: 2 }, children: "Signed in as" }), _jsx("div", { style: { fontSize: 12, color: '#888', wordBreak: 'break-all' }, children: email })] }), _jsxs("button", { onClick: () => { setOpen(false); signOut(auth); }, style: {
                        ...
                        }, onMouseEnter: (e) => { e.currentTarget.style.background = 'rgba(239,68,68,0.08)'; }, onMouseLeave: (e) => { e.currentTarget.style.background = 'none'; }, children: [_jsx("span", { style: { fontSize: 15 }, children: "\u2192" }), "Sign out"] })] }))] }));
}
function GenBadge({ remaining, limit, tier, atLimit, onUpgrade }) {
    ...
    if (isUnlimited) {
        return (_jsxs("div", { style: {
                ...
                color: '#c084fc',
                whiteSpace: 'nowrap',
            }, children: [_jsx("span", { style: { fontSize: 10 }, children: "\u2726" }), "Unlimited"] }));
    }
    if (atLimit) {
        return (_jsxs("button", { onClick: onUpgrade, style: {
                display: 'flex',
                alignItems: 'center',
                gap: 6,
                padding: '5px 12px',
            ...
            }, onMouseEnter: (e) => { e.currentTarget.style.background = 'rgba(239,68,68,0.18)'; }, onMouseLeave: (e) => { e.currentTarget.style.background = 'rgba(239,68,68,0.1)'; }, children: [_jsx("span", { style: { fontSize: 14 }, children: "\u26A1" }), "0 left \u00B7 Upgrade"] }));
    }
    ...
    return (_jsxs("div", { style: {
            ...
            color: '#f0f0f5',
            whiteSpace: 'nowrap',
        }, children: [_jsx("span", { style: { display: 'flex', alignItems: 'center', gap: 4 }, children: dots.map((used, i) => (_jsx("span", { style: {
                        width: 7,
                        height: 7,
                        borderRadius: '50%',
                    ...
                    } }, i))) }), _jsxs("span", { style: { color: remaining === 1 ? '#f59e0b' : '#f0f0f5' }, children: [remaining, " left"] }), _jsx("span", { style: {
                    fontSize: 10,
                    fontWeight: 600,
