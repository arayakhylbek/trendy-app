...
function applyGrdR(canvas, ctx) {
    ...
    // 6. Soft vignette
    const vg = ctx.createRadialGradient(width / 2, height * 0.45, height * 0.12, width / 2, height * 0.5, Math.max(width, height) * 0.78);
...
export async function applyFilter(dataUrl, filterId) {
